...
export const Logo = forwardRef((props, ref) => {
  ...
  const singleLogo = <Box alt="logo" component="img" src="/assets/logo-single.png" />;

  const fullLogo = <Box alt="logo" component="img" src="/assets/logo-full.png" />;
